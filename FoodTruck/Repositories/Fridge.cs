...
public interface Fridge : FoodStorageUnit
{
}

public class SilverFridgeInTheBackRightCorner : Fridge
{
    private readonly FoodTruckDbContext _context;

    public SilverFridgeInTheBackRightCorner(FoodTruckDbContext context)
    {
        _context = context;
    }
    ...
    {
        var itemStock = _context.FridgeStock.Single(fridgeStock => fridgeStock.Item == typeof(TItem).Name);
